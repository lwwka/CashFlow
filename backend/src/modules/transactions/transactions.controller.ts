...
export class TransactionsController {
  ...
  list(@Query() query: QueryTransactionsDto): Promise<TransactionRecord[]> {
    return this.transactionsService.list(query);
  }

  @Post()
  create(@Body() body: CreateTransactionDto): Promise<TransactionRecord> {
    return this.transactionsService.create(body);
  }

  @Patch(':id')
  update(@Param('id') id: string, @Body() body: UpdateTransactionDto): Promise<TransactionRecord> {
